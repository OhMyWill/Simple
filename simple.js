...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		faketeks = '©𝙈𝙊𝙉𝘼𝘼.' //Ganti Aja Nama Luh
		const isUrl = (url) => {
...
//━━━━━━━━━━━━━━━[ BUTTON ]━━━━━━━━━━━━━━━━━//
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = simple.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝑴𝑬𝑵𝑼 𝙈𝙊𝙉𝘼𝘼.","footerText": `Hallo Kak :v\n🔖Name Bot = 𝙈𝙊𝙉𝘼𝘼.\nKLIK MENU NYA KAK :)`,"listType": "SINGLE_SELECT","sections": list}}, {})
        ...
        const fakeitem = (teks) => {
           simple.sendMessage(from, teks, text, {
                   quoted: {
                           ...
                           },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync("./media/Menu.jpg"),"itemCount":999999999,"status":"INQUIRY","surface":"CATALOG","message": `ciptaan : OhMyWill 📎`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}},
...
but = [
          ...
          { buttonId: `${prefix}stickermenu`, buttonText: { displayText: '💮STICKER💮' }, type: 1 },
        ]
...
simple.updatePresence(from, Presence.recording)
   ...
   sendButImage(from, pll, `𝙈𝙊𝙉𝘼𝘼. © 2021`, cewe, [                      
          {
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `©_𝙈𝙊𝙉𝘼𝘼._ *V : 2.889H*`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
for (let _ of anu) {
sendMess(_.jid, `[ *BOT 𝙈𝙊𝙉𝘼𝘼. BROADCAST* ]\n\n${body.slice(4)}`)
}
reply('Suksess broadcast')
}
break
...
but = [
        ...
        sendButton(from, teks, '©Created : 𝙈𝙊𝙉𝘼𝘼.', but, mek)
break
